...
function UpdateLetter(props) {
    const [recipient,setRecipient] = useState(props.letter.recipient)
    const [when,setWhen] = useState(props.letter.when)
    const [content,setContent] = useState(props.letter.content)
    const [color,setColor] = useState(props.letter.color)
    ...
    function update(body) {
        ...
        fetch(`${backendurl}/api/Letter/${props.letter.id}`, requestOptions)
        .then((response) => {
